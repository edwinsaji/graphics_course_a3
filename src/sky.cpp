...
//==================================================================================
void sky::create_mesh(int no_of_longs, int no_of_lats)
{
...
//==================================================================================
void sky::get_shaders(std::string vertex_shader, std::string fragment_shader)
{
...
void sky::set_constant_uniforms(ONAS_state state)
{
	//glUseProgram(this->shader);
...
void sky::set_non_constant_uniforms(MVPmatrices set)
{
	GLuint location;
